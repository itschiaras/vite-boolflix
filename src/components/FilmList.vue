<template>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 row-cols-lg-6 flex-nowrap film-container align-items-center ps-3">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 row-cols-lg-6 flex-nowrap film-container mb-3 align-items-center ps-3">
...
<script>
    ...
    export default {
        name: 'FilmList',
        components: {CardFilm, CardTvSeries},
        data() {
            return {
                store
            }
